...
public class ControllerA : MonoBehaviour {
	...
	void Start () {
		...
		WheelColRL.transform.localPosition = startPosRL;
		WheelColFL.transform.localPosition = startPosFL;
		WheelColRR.transform.localPosition = startPosRR;
		WheelColFR.transform.localPosition = startPosFR;
	...
	void Update () {
		...
		wheelFL.transform.localRotation = WheelColFL.transform.rotation * Quaternion.Euler (startRotFL[0] , startRotFL[1], startRotFL[2] + WheelColFL.steerAngle);
		wheelFR.transform.localRotation = WheelColFR.transform.rotation * Quaternion.Euler (startRotFR[0] , startRotFR[1], startRotFR[2] + WheelColFL.steerAngle);

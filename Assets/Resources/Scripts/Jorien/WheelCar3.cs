...
public class WheelCar3 : MonoBehaviour { 
	...
	public wheelDrive2 wheelDrive2 = wheelDrive2.Front; 
	...
	class WheelData {
		public WheelCollider transform;
	...
	WheelData SetWheelParams(WheelCollider wheel, float maxSteer, bool motor) {
...
//		result.startPos = go.transform.localPosition; // store the current local pos of wheel
	...
	void Start () {
		...
		bool frontDrive = (wheelDrive2 == wheelDrive2.Front) || (wheelDrive2 == wheelDrive2.All);
		bool backDrive = (wheelDrive2 == wheelDrive2.Back) || (wheelDrive2 == wheelDrive2.All);	

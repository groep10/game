...
//		public GameObject go;
	...
	WheelData SetWheelParams(Transform wheel, float maxSteer, bool motor, string pos) {
	...
	void Start () {
		...
		bool frontDrive = (wheelDrive3 == wheelDrive3.Front) || (wheelDrive3 == wheelDrive3.All);
		bool backDrive = (wheelDrive3 == wheelDrive3.Back) || (wheelDrive3 == wheelDrive3.All);	
		wheels[0] = SetWheelParams(wheelFR, maxSteerAngle, frontDrive, "FR");
		wheels[1] = SetWheelParams(wheelFL, maxSteerAngle, frontDrive, "FL");
		wheels[2] = SetWheelParams(wheelBR, 0.0f, backDrive, "BR");
		wheels[3] = SetWheelParams(wheelBL, 0.0f, backDrive, "BL");
